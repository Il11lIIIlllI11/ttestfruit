...
var Ammo = (function() {
    ...
    return (function(Ammo) {
        ...
        var aa = {}, ca;
        for (ca in g)
            g.hasOwnProperty(ca) && (aa[ca] = g[ca]);
        var da = !1
          , ea = !1
          , fa = !1
          , ha = !1
        ...
        for (ca in aa)
            aa.hasOwnProperty(ca) && (g[ca] = aa[ca]);
        aa = null;
        var ra = {
        ...
        function ya(a, c, d) {
            ...
            for (d = c; a[d] && !(d >= e); )
                ++d;
            if (16 < d - c && a.subarray && xa)
                return xa.decode(a.subarray(c, d));
            for (e = ""; c < d; ) {
                var f = a[c++];
                if (f & 128) {
                    var n = a[c++] & 63;
                    if (192 == (f & 224))
                        e += String.fromCharCode((f & 31) << 6 | n);
                    else {
                        var r = a[c++] & 63;
        ...
        g.asm = function() {
            ...
            if (g.instantiateWasm)
                try {
                    ...
                    return qa("Module.instantiateWasm callback failed with error: " + f),
                    !1
                }
            (function() {
                if (sa || "function" !== typeof WebAssembly.instantiateStreaming || Wa() || "function" !== typeof fetch)
                    return d(c);
                fetch(Xa, {
                    credentials: "same-origin"
                }).then(function(a) {
            ...
            try {
                for (var f = 0, n = 0; n < d; n++) {
                    for (var r = h[c + 8 * n >> 2], N = h[c + (8 * n + 4) >> 2], ba = 0; ba < N; ba++) {
                        var Ia = Aa[r + ba]
                          , va = eb[a];
                        0 === Ia || 10 === Ia ? ((1 === a ? pa : qa)(ya(va, 0)),
                        va.length = 0) : va.push(Ia)
                    }
                    f += N
                }
                h[e >> 2] = f;
        ...
        function yb(a, c) {
            for (a = new Date(a.getTime()); 0 < c; ) {
                ...
                if (c > e - a.getDate())
                    c -= e - a.getDate() + 1,
                    a.setDate(1),
                    11 > d ? a.setMonth(d + 1) : (a.setMonth(0),
        ...
        function zb(a, c, d, e) {
            ...
            for (var va in Ia)
                d = d.replace(new RegExp(va,"g"), Ia[va]);
        ...
        var ab = {
            ...
            e: function(a, c) {
                if (0 === a)
                    a = Date.now();
                else if (1 === a && (fa || "undefined" !== typeof dateNow || "object" === typeof performance && performance && "function" === typeof performance.now))
                    a = mb();
                else
                    return db(28),
                    -1;
            ...
            if (!(0 < Ta)) {
                if (g.preRun)
                    for ("function" == typeof g.preRun && (g.preRun = [g.preRun]); g.preRun.length; )
                        Qa();
                Ka(La);
                0 < Ta || (g.setStatus ? (g.setStatus("Running..."),
                setTimeout(function() {
                    setTimeout(function() {
                        g.setStatus("")
                    }, 1);
        ...
        b = {
            ...
            Vs: function(a, c) {
                ...
                a = a + 7 & -8;
                b.Qs + a >= b.size ? (assert(0 < a),
                b.Ps += a,
                c = g._malloc(a),
                b.Ws.push(c)) : (c = b.buffer + b.Qs,
                b.Qs += a);
                return c
            },
            copy: function(a, c, d) {
        ...
        xv.prototype.Compute = function(a, c, d, e, f, n, r) {
            ...
            c && "object" === typeof c && (c = c.zs);
            d && "object" === typeof d && (d = d.zs);
            "object" == typeof e && "object" === typeof e && (ba = b.Vs(e, h),
            b.copy(e, h, ba),
            e = ba);
            f && "object" === typeof f && (f = f.zs);
            n && "object" === typeof n && (n = n.zs);
